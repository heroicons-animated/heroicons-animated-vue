<template>
  ...
  >
    ...
    >
      ...
      />
      <path ref="squareRef" d="M6 7.5h3v3H6v-3Z" />
      <path ref="line1Ref" d="M12 7.5h1.5" />
      <path ref="line2Ref" d="M12 10.5h1.5" />
      <path ref="line3Ref" d="M6 13.5h7.5" />
      <path ref="line4Ref" d="M6 16.5h7.5" />
    </svg>
  </div>
</template>
...
const squareRef = ref<SVGPathElement | null>(null);
...
const line4Ref = ref<SVGPathElement | null>(null);
