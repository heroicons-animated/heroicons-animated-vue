<template>
  ...
  >
    ...
    >
      ...
      />
      <Motion is="path" ref="checkRef" d="M9 15l2.25 2.25L15 12" />
    </svg>
  </div>
</template>
...
<script setup lang="ts">
  ...
  // Match React PATH_VARIANTS: check path pathLength [0,1] opacity [0,1] 0.4s easeInOut
  const variants = {
  ...
  const motionInstance = useMotion(checkRef, {
