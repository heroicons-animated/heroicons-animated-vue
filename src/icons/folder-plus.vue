<template>
  ...
  >
    ...
    >
      ...
      />
      <path ref="verticalLineRef" d="M12 10.5v6" />
      <path ref="horizontalLineRef" d="M9 13.5h6" />
    </svg>
  </div>
</template>
...
<script setup lang="ts">
  ...
  const verticalLineRef = ref<SVGPathElement | null>(null);
  const horizontalLineRef = ref<SVGPathElement | null>(null);
