<template>
  ...
  >
    ...
    >
      ...
      />
      <path :custom="0" d="M6.75 6.75H7.5V7.5H6.75V6.75Z" />
      <path :custom="0.05" d="M6.75 16.5H7.5V17.25H6.75V16.5Z" />
      <path :custom="0.1" d="M16.5 6.75H17.25V7.5H16.5V6.75Z" />
      <path :custom="0.15" d="M13.5 13.5H14.25V14.25H13.5V13.5Z" />
      <path :custom="0.2" d="M13.5 19.5H14.25V20.25H13.5V19.5Z" />
      <path :custom="0.25" d="M19.5 13.5H20.25V14.25H19.5V13.5Z" />
      <path :custom="0.3" d="M19.5 19.5H20.25V20.25H19.5V19.5Z" />
      <path :custom="0.35" d="M16.5 16.5H17.25V17.25H16.5V16.5Z" />
    </svg>
  </div>
</template>
