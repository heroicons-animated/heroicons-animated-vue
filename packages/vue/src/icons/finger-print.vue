<template>
  ...
  >
    ...
    >
      <Motion is="path" ref="pathRef" d="M7.86391 4.24259C9.04956 3.45731 10.4714 3 12 3C16.1421 3 19.5 6.35786 19.5 10.5C19.5 13.4194 18.9443 16.2089 17.9324 18.7685" fill="none"
            strokeOpacity={0.4} />
          <path
